...
public slots:
    /**
     * @brief Aktualizuje tłumaczenia interfejsu.
     *
     * Slot wywoływany po zmianie języka, który odświeża wszystkie teksty ustawione
     * przy pomocy metody tr(), wywołując metodę retranslateUi() wygenerowaną przez Qt Designer,
     * a także ewentualnie aktualizuje teksty ustawiane dynamicznie.
     */
