    ...
    , ui(new Ui::MainWindow)
{
    ...
    connect(translator, &Translator::languageChanged, this, &MainWindow::updateTranslations);
...
{
    ChartWindow::openChartWindow(serialHandler);
}
...
void MainWindow::on_pushButtonStart_clicked()
{
    ...
    if (serialHandler->isReading()) {
        ...
        ui->pushButtonStart->setStyleSheet(tr("background-color: red; color: white;"));
    } else {
        ui->pushButtonStart->setText(tr("Start"));
        ui->pushButtonStart->setStyleSheet(tr("background-color: green; color: white;"));
    }
}
...
void MainWindow::updateTranslations() {
    // Aktualizujemy statyczne elementy generowane przez Qt Designer:
    ui->retranslateUi(this);
    // Tutaj można dodać dodatkowe aktualizacje, jeśli masz elementy ustawiane dynamicznie.
}
